    ...
    >
      ...
      <div className="py-9 px-8">
        <div className="border rounded-lg">
          <label className="cursor-pointer py-4 px-[10px] border-b w-[380px] h-[42px] flex justify-center items-center">
            <input type="radio" checked className="w-5 h-5" />
            <div className="flex justify-between h-[18px] pl-3 w-[326px] text-sm text-gray-500">
              Türkçe
              <img
      ...
      <button className="ml-8 h-[48px] w-[382px] bg-primary-brand-color hover:bg-secondary-brand-color text-white rounded-lg text-sm font-semibold ">
        Güncelle
      </button>
    </div>
  );
